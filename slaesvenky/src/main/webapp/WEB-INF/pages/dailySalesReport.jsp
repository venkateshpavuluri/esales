			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="box">
						<!-- Box Head -->
						<div class="box-head">
							<h2>Daily Sales Report All Branches</h2>
						</div>
						<!-- End Box Head -->
                       
						
							<div class="form" id="msgInfo">
							<form:form action="dailySalesReport.htm" id="dSales" method="GET" commandName="dSalesCmd">
							...
							<tr>
								<td><spring:message code="label.sdate" /><font
									color="red"><strong>*</strong></font>:</td>
